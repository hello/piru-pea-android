...
public class BarGraph extends View {
    ...
    public void onDraw(Canvas ca) {
        ...
        if (mFullImage == null || mShouldUpdate) {
            ...
            float maxValue = 0;
            float padding = 0.0f * mContext.getResources().getDisplayMetrics().density;
            ...
            if (mShowAxis){
                ...
                canvas.drawLine(0, getHeight()-bottomPadding, getWidth(), getHeight()-bottomPadding, mPaint);
            }
            ...
            for (final Bar bar : mBars) {
                ...
                if (mShowAxis && bar.getName() != null){
                    ...
                    int y = (int) (getHeight() - bottomPadding);
                ...
                if (mShowBarText){
                    ...
                    canvas.drawText(bar.getValueString(),
                            ...
                            mRectangle.top-(mRectangle.top - boundTop) / 2f + (float)Math.abs(r2.top - r2.bottom) / 2f * 0.7f,
                            this.mPaint);
                }
